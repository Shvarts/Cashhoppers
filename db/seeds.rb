...
60.times do |t|
  hop = Hop.create!(close: false, event: 'new year', daily: false, code: 'ewre', price: 12, jackpot: 34, name: "hop #{t}" , producer_id: admin.id, time_end: '16/07/2013 10:46:16', time_start: '16/07/2013 10:46:18')
