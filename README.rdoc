...
other ads
    ...
    url: http://localhost:3000/api/ads/get_ads.json?t=e&api_key=123&authentication_token=7GdoffcF2eYSgXxYWQActdmCYxIqFB&ad_type=log_in
...
==== get regular hops(method: GET)
    ...
    response:
        success: {"hops"=>[{"id"=>1, "name"=>"hop #1", "time_start"=>"01/07/2013 11:35:32", "time_end"=>"01/07/2013 11:35:32", "code"=>"345", "price"=>"2", "jackpot"=>34, "daily
                 "=>false, "close"=>false, "event"=>"new year", "created_at"=>"2013-07-22T08:35:50Z", "updated_at"=>"2013-07-22T08:35:50Z"}, {"id"=>2, "name"=>"hop #2", "time_st
                 art"=>"16/07/2013 11:36:35", "time_end"=>"31/07/2013 11:36:35", "code"=>"3", "price"=>"34", "jackpot"=>3, "daily"=>false, "close"=>false, "event"=>"new year", "
                 created_at"=>"2013-07-22T08:36:51Z", "updated_at"=>"2013-07-22T08:36:51Z"}]}
        error: {"errors"=>["Hops not found."], "success"=>false, "status"=>406}
====get daily hops (today)(method: GET)
    url: http://localhost:3000/api/hops/daily.json?t=e&api_key=123&authentication_token=ZyI1Lpv0jrujOodUCwcsdzDYRWUc5y&page=1&per_page=10
    data: {api_key: 123, authentication_token: kNvOIDu1WR0f8MUYjnYdHpXgnYC0dO, page: 1, per_page: 10}
    response:
        success: {"hops"=>[{"id"=>3, "name"=>"daily hop #1", "time_start"=>"22/07/2013 11:44:01", "time_end"=>nil, "code"=>nil, "price"=>nil, "jackpot"=>nil, "daily"=>true, "clo
        error: {"errors"=>["Hops not found."], "success"=>false, "status"=>406}
====assign to hop
    url: http://localhost:3000/api/hops/assign.json?t=e&api_key=123&authentication_token=lgzYkMy0uUrBisPuuAkhfqVSKbsgp4&hop_id=1
    data: {api_key: 123, authentication_token: kNvOIDu1WR0f8MUYjnYdHpXgnYC0dO, hop_id: 1}
    response:
        success: {"success"=>true, "info"=>"Assigned to hop successfully!", "status"=>200}
        error: {"errors"=>["Hop not found."], "success"=>false, "status"=>406}
               {"errors"=>["User already assigned to this hop."], "success"=>false, "status"=>406}
