...
====get friends hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"id" => 1, "user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:50:22Z", "comment"=>"friend task #1",
                    "hop_id"=>4, "photo"=>"/images/user_hop_task_photos/tasks/7/original/PHOTO.jpg?1374562222", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"},

                    {"id" => 1, "user_id"=>2, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:50:23Z", "comment"=>"friend task #2",
                    "hop_id"=>3, "photo"=>"/images/user_hop_task_photos/tasks/8/original/PHOTO.jpg?1374562223", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"},

                    {"id" => 1, "user_id"=>2, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:50:25Z", "comment"=>"friend task #3",
                    "hop_id"=>2, "photo"=>"/images/user_hop_task_photos/tasks/9/original/PHOTO.jpg?1374562225", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"}
                 ]}
====get all hoppers hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"id" => 1, "user_id"=>3, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:52:27Z", "comment"=>"other_user task #3",
                    "hop_id"=>2, "photo"=>"/images/user_hop_task_photos/tasks/12/original/PHOTO.jpg?1374562347", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"},

                    {"id" => 1, "user_id"=>3, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:52:26Z", "comment"=>"other_user task #2",
                    "hop_id"=>3, "photo"=>"/images/user_hop_task_photos/tasks/11/original/PHOTO.jpg?1374562346", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"},

                    {"id" => 1, "user_id"=>3, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:52:25Z", "comment"=>"other_user task #1",
                    "hop_id"=>4, "photo"=>"/images/user_hop_task_photos/tasks/10/original/PHOTO.jpg?1374562345", "likes_count"=>1,
                    "liked"=>true, "hop_task_text"=>"Take your picture with ...!", "time_ago"=>"about 2 hours"}
                 ]}
...
====get user hop task comments(method: GET)
    ...
    response:
        success: {"comments"=>[
                    ...
                    {"user_id"=>1, "text"=>"hello its comment #1", "created_at"=>"2013-07-23T15:36:18Z", "time_ago"=>"about 2 hours"},
                    {"user_id"=>1, "text"=>"hello its comment #2", "created_at"=>"2013-07-23T15:36:19Z", "time_ago"=>"about 2 hours"},
                    {"user_id"=>1, "text"=>"hello its comment #3", "created_at"=>"2013-07-23T15:36:20Z", "time_ago"=>"about 2 hours"},
                    {"user_id"=>1, "text"=>"hello its comment #4", "created_at"=>"2013-07-23T15:36:21Z", "time_ago"=>"about 2 hours"},
                    {"user_id"=>1, "text"=>"hello its comment #5", "created_at"=>"2013-07-23T15:36:22Z", "time_ago"=>"about 2 hours"},
                    {"user_id"=>1, "text"=>"hello its comment #6", "created_at"=>"2013-07-23T15:36:23Z", "time_ago"=>"about 2 hours"}
                  ]}
...
====notifications(method: GET)
    ...
    data: {api_key: 123, authentication_token: H2zCS5AfvAIbS0OdRY6SCJAjM6RM2F, page: 1, per_page: 5}
    response: {"events"=>[
                  {"event_type"=>"Friend invite", "created_at"=>"2013-07-31T14:19:11Z", "comment"=>nil, "like"=>nil, "prize"=>nil,
                  "friend"=>{"id"=>2, "last_name"=>"friend", "first_name"=>"friend", "user_name"=>"friend", "avatar"=>nil, "friends_count"=>1, "time_ago"=>"about 2 hours"}},

                  {"event_type"=>"End of hop", "created_at"=>"2013-07-30T11:09:40Z", "comment"=>nil, "like"=>nil,
                  "prize"=>{"cost"=>22, "place"=>1, "user_id"=>2, "hop_id"=>20}, "friend"=>nil, "time_ago"=>"about 2 hours"},

                  {"event_type"=>"End of hop", "created_at"=>"2013-07-30T11:09:40Z", "comment"=>nil, "like"=>nil,
                  "prize"=>{"cost"=>12, "place"=>2, "user_id"=>3, "hop_id"=>20}, "friend"=>nil, "time_ago"=>"about 2 hours"},

                  {"event_type"=>"Comment", "created_at"=>"2013-07-30T10:43:15Z", "comment"=>{"text"=>"hello its comment.", "user_id"=>2},
                  "like"=>nil, "prize"=>nil, "friend"=>nil, "time_ago"=>"about 2 hours"},

                  {"event_type"=>"Like", "created_at"=>"2013-07-30T10:43:14Z", "comment"=>nil, "like"=>{"user_id"=>2},
                  "prize"=>nil, "friend"=>nil, "time_ago"=>"about 2 hours"},

                  {"event_type"=>"Friend invite accept", "created_at"=>"2013-07-29T14:19:12Z", "comment"=>nil, "like"=>nil,
                  "prize"=>nil, "friend"=>{"id"=>2, "last_name"=>"friend", "first_name"=>"friend", "user_name"=>"friend", "avatar"=>nil
                  , "time_ago"=>"about 2 hours", "friends_count"=>1}}
              ]}
===Messages
...
====synchronize messages(method: GET)
    ...
    response:
        success: {"messages"=>[
                    {"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:41:32Z", "time_ago"=>"about 17 hours"},
                    {"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:42:09Z", "time_ago"=>"about 17 hours"},
                    {"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:42:30Z", "time_ago"=>"about 17 hours"},
                    {"sender_id"=>2, "text"=>"broosdfdfs",         "created_at"=>"2013-07-25T13:52:41Z", "time_ago"=>"about 17 hours"},
                    {"sender_id"=>2, "text"=>"broosdfdfs",         "created_at"=>"2013-07-25T13:59:39Z", "time_ago"=>"about 17 hours"}
                  ]}
====friends messages thread(method: GET)
    ...
    response:
        success: {"friends"=>[
                    {"friend_id"=>2, "friend_avatar"=>"/images/avatars/users/2/original/USER_AVATAR.png?1374757321", "friend_first_name"=>"friend", "friend_last_name"=>
                    "friend", "friend_user_name"=>"friend", "last_message_id"=>6, "last_message_text"=>"broosdfdfs", "last_message_created_at"=>"2013-07-25T13:59:39Z", "time_ago"=>"about 17 hours"},

                    {"friend_id"=>3, "friend_avatar"=>"/images/avatars/users/3/original/USER_AVATAR.png?1374757321", "friend_first_name"=>"other_user", "friend_last_name"=>"other_user", "fri
                    end_user_name"=>"other_user", "last_message_id"=>7, "last_message_text"=>"well", "last_message_created_at"=>"2013-07-26T10:34:55Z", "time_ago"=>"about 17 hours"}
                 ]}
