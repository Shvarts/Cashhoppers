...
====like user hop task(method: POST)
    ...
    data: {"api_key":"123","authentication_token":"gxNd68bCxjICtftu7Ja8Bj2H2FOYCY","hop_task_id":"2"}
    response:
        success: {"success"=>true, "info"=>"Like Successfully!", "likes_count"=>2, "hop_task_id"=>2, "status"=>200}
...
====get likes count fop user hop task(method: GET)
    url: http://localhost:3000/api/task/likes_count.json?api_key=123&authentication_token=LktpFvEY4ZNH1iqZOOI2X5iNirMdJi&hop_task_id=2
    data: {"api_key":"123","authentication_token":"gxNd68bCxjICtftu7Ja8Bj2H2FOYCY","hop_task_id":"2"}
    response:
        success: {"likes_count"=>3, "hop_task_id"=>2}
        error: {"errors"=>["Hop task not found."], "success"=>false, "status"=>406}
