...
====get hop score for current user(method: GET)
    ...
    data: {api_key: 123, authentication_token: kNvOIDu1WR0f8MUYjnYdHpXgnYC0dO, hop_id: 1}
    response:
        success: {"success"=>true, "score"=>0, "status"=>200}
        error: {"errors"=>["Hop not found."], "success"=>false, "status"=>406}
...
====get friends hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:50:22Z", "comment"=>"friend task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_phot
                    os/tasks/7/original/PHOTO.jpg?1374562222", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"user_id"=>2, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:50:23Z", "comment"=>"friend task #2", "hop_id"=>3, "ph
                    ...
                    {"user_id"=>2, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:50:25Z", "comment"=>"friend task #3", "hop_id"=>2, "photo"=>"/images/user_hop
...
====get all hoppers hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"user_id"=>3, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:52:27Z", "comment"=>"other_user task #3", "hop_id"=>2, "photo"=>"/images/user_hop_task_
                    photos/tasks/12/original/PHOTO.jpg?1374562347", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"user_id"=>3, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:52:26Z", "comment"=>"other_user task #2", "hop_id
                    ...
                    {"user_id"=>3, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:52:25Z", "comment"=>"other_user task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_photos/tasks
...
====get user hop task by id(method: GET)
    ...
    response:
        success: {"user_hop_task"=>{"user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-24T15:51:54Z", "comment"=>"new api test", "hop_id"=>1, "photo"=>"/images/user_hop_task
                 _photos/tasks/13/original/PHOTO.png?1374681114", "likes_count"=>0, "comments_count"=>0, "liked"=>false, "user_first_name"=>"friend", "user_last_name"=>"friend",
                 "user_user_name"=>"friend", "user_avatar"=>"/images/avatars/users/2/original/USER_AVATAR.png?1374665706"}}
        error: {"errors"=>["Already shared."], "success"=>false, "status"=>406}
               {"errors"=>["User hop task not found."], "success"=>false, "status"=>406}
===Notifications
