...
==== set(method: POST)
    ...
    data: {"api_key":"123","authentication_token":"w39DhgIgCnZ1eBnyGr5rzGHfNXoJTW","user_settings":"{:friend_invite=>true, :friend_invite_accept=>false,
          :end_of_hop=>false, :comment=>true, :like=>false}"}
    response:
...
==== get(method: GET)
    ...
    response:
        success: {"friend_invite"=>true, "friend_invite_accept"=>false, "end_of_hop"=>false, "comment"=>true, "like"=>false}
