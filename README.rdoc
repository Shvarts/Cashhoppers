...
====get hop tasks(method: GET)
    ...
    response:
        success: {"hop_tasks"=>[{"id"=>1, "price"=>"34", "amt"=>34, "bonus"=>343, "pts"=>343, "sponsor_id"=>1, "text"=>"tester #dgs",
                  "hop_id"=>1, "completed"=>false, "logo"=>"/images/hop_task_logos/hop_tasks/205/Task_LOGO.png?1375717339"}]}
...
====get yesterday's winner
    ...
    response:
        success: {"success"=>true, "winner_id"=>2, "score"=>222, "hoppers_count"=>3, "rank"=>1, "hop_id"=>22, "cost"=>23, "status"=>200}
...
====notifications(method: GET)
    ...
    response: {"events"=>[
                  ...
                  {
                        "event_type"=>"End of hop",
                        "created_at"=>"2013-07-30T11:09:40Z",
                        "comment"=>nil,
                        "like"=>nil,
                        "prize"=>{
                            "cost"=>22,
                  ...
                  {
                        "event_type"=>"Friend invite accept",
                        "created_at"=>"2013-07-29T14:19:12Z",
                        "comment"=>nil,
                        "like"=>nil,
                        "prize"=>nil,
                        "friend"=>{
