...
=== Hops
-get daily hops
-get my friends hop tasks
- get all users hop tasks
...
====get friends hop tasks(method: GET)
    url: http://localhost:3000/api/tasks/get_friends_hop_tasks.json?api_key=123&authentication_token=bNXt6axDNm12vWJAOE9RRiXQUbylQt
    data: {api_key: 123, authentication_token: H2zCS5AfvAIbS0OdRY6SCJAjM6RM2F}
    response:
