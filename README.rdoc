...
====get user hop task by id(method: GET)
    ...
    response:
        success: {"user_hop_task"=>{"user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-24T15:51:54Z", "comment"=>"new api test", "hop_id"=>1, "hop_task_text"=>"Take your pic
                ...
                "likers"=>["admin CashHoppers", "friend friend"]}}
        error: {"errors"=>["Already shared."], "success"=>false, "status"=>406}
               {"errors"=>["User hop task not found."], "success"=>false, "status"=>406}
===Notifications
====notifications(method: GET)
    ...
    response: {"events"=>[
              ...
              {"event_type"=>"Friend invite", "created_at"=>"2013-07-31T14:19:11Z", "comment"=>nil, "like"=>nil, "prize"=>nil, "friend"=>{"id"=>2, "last_name"=>"friend", "first_name"=>"friend", "user_name"=>"friend",
              "avatar"=>nil, "friends_count"=>1}},

              {"event_type"=>"End of hop", "created_at"=>"2013-07-30T11:09:40Z", "comment"=>nil, "like"=>nil, "prize"=>{"cost"=>22, "place"=>1, "user_id"=>2, "hop_id"=>20}, "friend"=>nil},

              {"event_type"=>"End of hop", "created_at"=>"2013-07-30T11:09:40Z", "comment"=>nil, "like"=>nil, "prize"=>{"cost"=>12, "place"=>2, "user_id"=>3, "hop_id"=>20}, "friend"=>nil},

              {"event_type"=>"Comment", "created_at"=>"2013-07-30T10:43:15Z", "comment"=>{"text"=>"hello its comment.", "user_id"=>2}, "like"=>nil, "prize"=>nil, "friend"=>nil},

              {"event_type"=>"Like", "created_at"=>"2013-07-30T10:43:14Z", "comment"=>nil, "like"=>{"user_id"=>2}, "prize"=>nil, "friend"=>nil},

              {"event_type"=>"Friend invite accept", "created_at"=>"2013-07-29T14:19:12Z", "comment"=>nil, "like"=>nil, "prize"=>nil, "friend"=>{"id"=>2, "last_name"=>"friend", "first_name"=>"friend", "user_name"=>"friend", "avatar"=>nil
              , "friends_count"=>1}}
