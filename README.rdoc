...
====get friends hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[{"user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:50:22Z", "comment"=>"friend task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_phot
                 os/tasks/7/original/PHOTO.jpg?1374562222", "likes_count"=>1, "liked"=>true}, {"user_id"=>2, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:50:23Z", "comment"=>"friend task #2", "hop_id"=>3, "ph
                 oto"=>"/images/user_hop_task_photos/tasks/8/original/PHOTO.jpg?1374562223", "likes_count"=>1, "liked"=>true}, {"user_id"=>2, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:50:25Z", "comment"=>"
                 friend task #3", "hop_id"=>2, "photo"=>"/images/user_hop_task_photos/tasks/9/original/PHOTO.jpg?1374562225", "likes_count"=>1, "liked"=>true}]}
====get all hoppers hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[{"user_id"=>3, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:52:27Z", "comment"=>"other_user task #3", "hop_id"=>2, "photo"=>"/images/user_hop_task_
                 photos/tasks/12/original/PHOTO.jpg?1374562347", "likes_count"=>1, "liked"=>true}, {"user_id"=>3, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:52:26Z", "comment"=>"other_user task #2", "hop_id
                 "=>3, "photo"=>"/images/user_hop_task_photos/tasks/11/original/PHOTO.jpg?1374562346", "likes_count"=>1, "liked"=>true}, {"user_id"=>3, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:52:25Z", "c
                 omment"=>"other_user task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_photos/tasks/10/original/PHOTO.jpg?1374562345", "likes_count"=>1, "liked"=>true}]}
