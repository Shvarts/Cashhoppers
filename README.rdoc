...
====get user info(method: GET)
    url: http://localhost:3000/api/users/get_my_info.json?api_key=123&authentication_token=vtqviY0AGvo2lJbK62rXCZ6mrcJKFs&user_id=3
...
assigned: true if user assigned to hop of false if not
    ...
    response:
        success: {"hops"=>[{"id"=>7, "name"=>"new daily hop", "time_start"=>"23/07/2013 11:52:13", "time_end"=>nil, "code"=>nil, "price"=>nil, "jackpot"=>nil, "daily"=>true, "cl
                 ose"=>false, "event"=>nil, "created_at"=>"2013-07-23T08:52:21Z", "updated_at"=>"2013-07-23T08:52:21Z", "assigned"=>false, "score"=>0, "logo"=>"/images/hop_logos/hops/1/HOP_LOGO.jpg?1374831944"}]}
...
assigned: true if user assigned to hop of false if not
    ...
    response:
        success: {"hops"=>[{"id"=>1, "name"=>"hop #1", "time_start"=>"01/07/2013 11:35:32", "time_end"=>"01/07/2013 11:35:32", "code"=>"345", "price"=>"2", "jackpot"=>34, "daily
                 "=>false, "close"=>false, "event"=>"new year", "created_at"=>"2013-07-22T08:35:50Z", "updated_at"=>"2013-07-22T08:35:50Z", "assigned"=>true, "score"=>0, "logo"=>"/images/hop_logos/hops/1/HOP_LOGO.jpg?1374831944"}, {"id"=>2, "name"=>"hop #2", "time_st
                 art"=>"16/07/2013 11:36:35", "time_end"=>"31/07/2013 11:36:35", "code"=>"3", "price"=>"34", "jackpot"=>3, "daily"=>false, "close"=>false, "event"=>"new year", "
                 created_at"=>"2013-07-22T08:36:51Z", "updated_at"=>"2013-07-22T08:36:51Z", "assigned"=>false, "score"=>0, "logo"=>"/images/hop_logos/hops/1/HOP_LOGO.jpg?1374831944"}]}
        error: {"errors"=>["Hops not found."], "success"=>false, "status"=>406}
====get hop tasks(method: GET)
    ...
    response:
        success: {"hop_tasks"=>[{"id"=>1, "price"=>"34", "amt"=>34, "bonus"=>343, "pts"=>343, "sponsor_id"=>1, "text"=>"tester #dgs", "hop_id"=>1, "completed"=>false}]}
...
====get hop by id(method: GET)
    ...
    data: {api_key: 123, authentication_token: kNvOIDu1WR0f8MUYjnYdHpXgnYC0dO, hop_id: 1}
    response:
        success: {"hop"=>{"id"=>2, "name"=>"admin reg hop #2", "time_start"=>"08/07/2013 09:38:42", "time_end"=>"08/07/2013 09:38:42", "code"=>"34", "price"=>"34", "jackpot"=>34
                 , "daily"=>false, "close"=>false, "event"=>"34", "created_at"=>"2013-07-23T06:39:03Z", "updated_at"=>"2013-07-23T06:39:03Z", "assigned"=>true, "score"=>0, "logo"=>"/images/hop_logos/hops/1/HOP_LOGO.jpg?1374831944"}}
        error: {"errors"=>["Hop not found."], "success"=>false, "status"=>406}
...
====get yesterday's winner
    ...
    response:
        success: {"success"=>true, "winner_id"=>2, "score"=>222, "hoppers_count"=>3, "rank"=>1, "hop_id"=>22, "status"=>200}
...
====get friends hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"id" => 1, "user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:50:22Z", "comment"=>"friend task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_phot
                    os/tasks/7/original/PHOTO.jpg?1374562222", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"id" => 1, "user_id"=>2, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:50:23Z", "comment"=>"friend task #2", "hop_id"=>3, "ph
                    oto"=>"/images/user_hop_task_photos/tasks/8/original/PHOTO.jpg?1374562223", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"id" => 1, "user_id"=>2, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:50:25Z", "comment"=>"friend task #3", "hop_id"=>2, "photo"=>"/images/user_hop
                    _task_photos/tasks/9/original/PHOTO.jpg?1374562225", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"}
                 ]}
====get all hoppers hop tasks(method: GET)
    ...
    response:
        success: {"tasks"=>[
                    {"id" => 1, "user_id"=>3, "hop_task_id"=>4, "created_at"=>"2013-07-23T06:52:27Z", "comment"=>"other_user task #3", "hop_id"=>2, "photo"=>"/images/user_hop_task_
                    photos/tasks/12/original/PHOTO.jpg?1374562347", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"id" => 1, "user_id"=>3, "hop_task_id"=>3, "created_at"=>"2013-07-23T06:52:26Z", "comment"=>"other_user task #2", "hop_id
                    "=>3, "photo"=>"/images/user_hop_task_photos/tasks/11/original/PHOTO.jpg?1374562346", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"},

                    {"id" => 1, "user_id"=>3, "hop_task_id"=>2, "created_at"=>"2013-07-23T06:52:25Z", "comment"=>"other_user task #1", "hop_id"=>4, "photo"=>"/images/user_hop_task_photos/tasks
                    /10/original/PHOTO.jpg?1374562345", "likes_count"=>1, "liked"=>true, "hop_task_text"=>"Take your picture with ...!"}
                 ]}
...
====get user hop task comments(method: GET)
    ...
    response:
        success: {"comments"=>[{"user_id"=>1, "text"=>"hello its comment", "created_at"=>"2013-07-23T15:12:16Z"}, {"user_id"=>1, "text"=>"hello its comment #0", "created_at"=>"2
                 013-07-23T15:36:17Z"}, {"user_id"=>1, "text"=>"hello its comment #1", "created_at"=>"2013-07-23T15:36:18Z"}, {"user_id"=>1, "text"=>"hello its comment #2", "cre
                 ated_at"=>"2013-07-23T15:36:19Z"}, {"user_id"=>1, "text"=>"hello its comment #3", "created_at"=>"2013-07-23T15:36:20Z"}, {"user_id"=>1, "text"=>"hello its comme
                 nt #4", "created_at"=>"2013-07-23T15:36:21Z"}, {"user_id"=>1, "text"=>"hello its comment #5", "created_at"=>"2013-07-23T15:36:22Z"}, {"user_id"=>1, "text"=>"hel
                 lo its comment #6", "created_at"=>"2013-07-23T15:36:23Z"}, {"user_id"=>1, "text"=>"hello its comment #7", "created_at"=>"2013-07-23T15:36:24Z"}, {"user_id"=>1,
                 "text"=>"hello its comment #8", "created_at"=>"2013-07-23T15:36:25Z"}, {"user_id"=>1, "text"=>"hello its comment #9", "created_at"=>"2013-07-23T15:36:27Z"}, {"u
                 ser_id"=>1, "text"=>"hello its comment ", "created_at"=>"2013-07-23T15:43:09Z"}, {"user_id"=>1, "text"=>"hello its comment ", "created_at"=>"2013-07-23T15:57:30
                 Z"}, {"user_id"=>1, "text"=>"hello its comment ", "created_at"=>"2013-07-23T15:58:03Z"}, {"user_id"=>1, "text"=>"hello its comment ", "created_at"=>"2013-07-23T
                 15:58:34Z"}, {"user_id"=>1, "text"=>"hello its comment ", "created_at"=>"2013-07-23T15:58:57Z"}]}
...
====get user hop task by id(method: GET)
    ...
    response:
        success: {"user_hop_task"=>{"user_id"=>2, "hop_task_id"=>2, "created_at"=>"2013-07-24T15:51:54Z", "comment"=>"new api test", "hop_id"=>1, "hop_task_text"=>"Take your pic
                ture with DEREVO!!!", "photo"=>"/images/user_hop_task_photos/tasks/13/original/PHOTO.png?1374681114", "likes_count"=>0, "comments_count"=>0, "liked"=>false,
                "user_first_name"=>"friend", "user_last_name"=>"friend", "user_user_name"=>"friend", "user_avatar"=>"/images/avatars/users/2/original/USER_AVATAR.png?1374665706"}}
        error: {"errors"=>["Already shared."], "success"=>false, "status"=>406}
               {"errors"=>["User hop task not found."], "success"=>false, "status"=>406}
===Notifications
====notifications(method: GET)
    ...
    data: {api_key: 123, authentication_token: H2zCS5AfvAIbS0OdRY6SCJAjM6RM2F, page: 1, per_page: 5}
    response: {"events"=>[
                {"event_type"=>"Like", "created_at"=>"2013-07-24T11:45:13Z", "comment_text"=>nil, "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>"CashH
                oppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Comment", "created_at"=>"2013-07-24T11:45:15Z", "comment_text"=>"hello its cnt ", "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>
                "CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Comment", "created_at"=>"2013-07-24T11:49:16Z", "comment_text"=>"hello its cnt ", "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>
                "CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Comment", "created_at"=>"2013-07-24T11:52:17Z", "comment_text"=>"hello its cnt ", "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>
                "CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Comment", "created_at"=>"2013-07-24T12:17:29Z", "comment_text"=>"hello its cnt ", "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>
                "CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Comment", "created_at"=>"2013-07-24T12:18:59Z", "comment_text"=>"hello its cnt", "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>"
                CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>1},

                {"event_type"=>"Friend invite", "created_at"=>"2013-07-24T12:41:41Z", "comment_text"=>nil, "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>"CashHo
                ppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>nil},

                {"event_type"=>"Friend invite accept", "created_at"=>"2013-07-24T12:44:19Z", "comment_text"=>nil, "user_id"=>1, "user_first_name"=>"admin", "user_last_name"=>
                "CashHoppers", "user_user_name"=>"admin", "user_avatar"=>"/images/avatars/users/1/original/USER_AVATAR.png?1374665706", "user_hop_task_id"=>nil}]}
===Messages
...
====synchronize messages(method: GET)
    ...
    data: {"api_key":"123","authentication_token":"1mS4qJw3qMZXJRyFoHR0TdKRqNavgr"}
    response:
        success: {"messages"=>[{"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:41:32Z"}, {"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=
                 >"2013-07-25T13:42:09Z"}, {"sender_id"=>2, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:42:30Z"}, {"sender_id"=>2, "text"=>"broosdfdfs", "created_
                 at"=>"2013-07-25T13:52:41Z"}, {"sender_id"=>2, "text"=>"broosdfdfs", "created_at"=>"2013-07-25T13:59:39Z"}]}
====friends messages thread(method: GET)
    ...
    response:
        success: {"friends"=>[{"friend_id"=>2, "friend_avatar"=>"/images/avatars/users/2/original/USER_AVATAR.png?1374757321", "friend_first_name"=>"friend", "friend_last_name"=
                 >"friend", "friend_user_name"=>"friend", "last_message_id"=>6, "last_message_text"=>"broosdfdfs", "last_message_created_at"=>"2013-07-25T13:59:39Z"}, {"friend_i
                 d"=>3, "friend_avatar"=>"/images/avatars/users/3/original/USER_AVATAR.png?1374757321", "friend_first_name"=>"other_user", "friend_last_name"=>"other_user", "fri
                 end_user_name"=>"other_user", "last_message_id"=>7, "last_message_text"=>"well", "last_message_created_at"=>"2013-07-26T10:34:55Z"}]}
====friend messages history(method: GET)
    ...
    data: {"api_key":"123","authentication_token":"1mS4qJw3qMZXJRyFoHR0TdKRqNavgr", page: 1, per_page: 10}
    response:
        success: {"messages"=>[{"id"=>1, "sender_id"=>1, "receiver_id"=>2, "text"=>"hello friend", "created_at"=>"2013-07-25T13:09:05Z"}, {"id"=>2, "sender_id"=>2, "receiver_id"
                 =>1, "text"=>"hello, friends !!!", "created_at"=>"2013-07-25T13:41:32Z"}]}
